    ...
    return (
        <section>
            <div className="bg-[#112152] text-white text-center pt-5 pb-3 border-t border-white flex flex-col items-center w-full">
                ...
                <div className="flex justify-center lg:justify-evenly gap-4 w-[28rem] md:w-1/2 py-3 border-b border-white">
                    <Partners />
                </div>
                <div className="text-xl w-[27rem] md:w-1/2 flex flex-col gap-3">
                    <p>
